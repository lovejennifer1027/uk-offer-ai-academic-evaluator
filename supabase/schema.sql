...
create index if not exists essay_submissions_created_at_idx
  on public.essay_submissions (created_at desc);

create index if not exists essay_submissions_total_score_idx
  on public.essay_submissions (total_score desc);
